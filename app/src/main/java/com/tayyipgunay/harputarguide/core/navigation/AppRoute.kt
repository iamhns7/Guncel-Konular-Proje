...
object AppRoute {
    ...
    const val DEFAULT_AR_PLACE_ID = "harput-kalesi"
    ...
    const val MODEL_VIEWER = "model_viewer/{$PLACE_ID_ARG}/{$HOTSPOT_ID_ARG}"
    ...
    fun modelViewer(placeId: String, hotspotId: String): String =
        "model_viewer/$placeId/$hotspotId"
